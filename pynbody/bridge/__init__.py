...
class Bridge(object):
    ...
    def catalog_transfer_matrix(self, min_index=1, max_index=30, groups_1=None, groups_2=None,use_family=None,only_family=None):
        ...
        restriction_end_indices = restricted_end_particles.get_index_list(end)
        ...
        g1 = groups_1.get_group_array(family=use_family)[restriction_start_indices]
        g2 = groups_2.get_group_array(family=use_family)[restriction_end_indices]
